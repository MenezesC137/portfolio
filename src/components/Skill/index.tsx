...
export default function Skill({ link, Icon, title, description }: SkillProps) {
  return (
    <a
      href={link}
      target="_blank"
      className="flex flex-col sm:w-full sm:h-56 md:w-56 md:h-60 bg-black-light rounded-[4px] p-5 justify-between bg-gradient-to-tr hover:from-red-dark hover:to-red-main group hover:cursor-pointer"
    >
